  ...
  return (
    <Modal isOpen={isOpen} onDismiss={() => onClose()}>
      <Wrapper>
        ...
        <Paragraph style={{fontSize: '12px', color: '#747474'}}>Please refer <Link href="" title="here"/> for introduction and further instruction. To get some PKF funds for your trial, please click <Link href="t.me/pkf_faucet_bot" title="here"/>.</Paragraph>
      </Wrapper>
    </Modal>
  )
}